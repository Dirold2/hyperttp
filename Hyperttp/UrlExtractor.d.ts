...
export default class UrlExtractor implements UrlExtractorInterface {
    ...
    extractId(url: string, entity: string, platform: string, castNumbers: false): Record<string, string>;
    extractId(url: string, entity: string, platform: string, castNumbers: true): Record<string, string | number>;
    extractId(url: string, entity: string, platform: string, castNumbers: boolean): Record<string, string | number>;
}
