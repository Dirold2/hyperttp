import { UrlExtractorInterface, UrlPattern } from "../Types/url-extractor";
...
export default class UrlExtractor implements UrlExtractorInterface {
  private patterns: Record<string, UrlPattern[]> = {};
   ...
   * ```
   */
  registerPlatform(platform: string, patterns: UrlPattern[]) {
